(function () {
  ...
  var elCodi     = document.getElementById('lina42-provcodi');
  var elNombre   = document.getElementById('lina42-provname');
  var elConcepto = document.getElementById('lina42-concepto');
  var elImporte  = document.getElementById('lina42-importe');
  var elBtnG     = document.getElementById('lina42-btn-guardar');
  var elBtnL     = document.getElementById('lina42-btn-limpiar');
  ...
  function validarProv() {
    ...
    fetch('/lina42/prov/info?provcodi=' + encodeURIComponent(cod))
