(function () {
  ...
  // ── Config ────────────────────────────────────────────────────────────────
  var _cfg = JSON.parse(document.getElementById('lina32-config').textContent || '{}');
  var HOY  = _cfg.hoy || '';

  // ── Elementos DOM ─────────────────────────────────────────────────────────
  var elDesde     = document.getElementById('lina32-desde');
  var elHasta     = document.getElementById('lina32-hasta');
  var elProvcodi  = document.getElementById('lina32-provcodi');
  var elProvname  = document.getElementById('lina32-provname');
  var elBtnCons   = document.getElementById('lina32-btn-consultar');
  var elTbody     = document.getElementById('lina32-tbody');
  var elStatus    = document.getElementById('lina32-status');
  var elCtx         = document.getElementById('lina32-ctx');
  var elCtxPdf      = document.getElementById('lina32-ctx-pdf');
  var elCtxTxt      = document.getElementById('lina32-ctx-txt');
  var elCtxAnular   = document.getElementById('lina32-ctx-anular');
  var elGridScroll  = document.getElementById('lina32-grid-scroll');
  ...
  function consultar() {
    ...
    fetch('/lina32/list?' + params.toString())
  ...
  elProvcodi.addEventListener('change', function () {
    ...
    fetch('/lina32/prov/info?provcodi=' + cod)
      .then(function (r) { return r.json(); })
